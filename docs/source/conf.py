# -*- coding: utf-8 -*-
#
# encore documentation build configuration file, created by
...
version = release = encore.__version__
...
html_title = "Encore Documentation"
...
latex_documents = [
  ('index', 'encore.tex', 'Encore Documentation',
...
man_pages = [
    ('index', 'encore', 'Encore Documentation',
     ['Enthought, Inc.'], 1)
]
